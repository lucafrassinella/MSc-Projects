...
%%%% PLOTS:
% Create ticks for date in x axis of plots:
num_ticks = 5;
...
% Store UKF results:
results.ex3.xx = mean_mat;
results.ex3.P = cov_mat;
% Store results at final time:
results.ex3.final_mean = mean_mat(:, end);
results.ex3.final_cov = cov_mat(:, :, end);
...
% -------------------------------------------------------------------------
% UKF - function to estimate mean and covariance at time k given data at
% time k-1 using an Unscented Kalman Filter
%
%   Inputs:
%       - mean: mean state at time step k-1 [n, 1]
%       - cov: covariance at time step k-1  [n, n]
%       - ti: previous time t_{k-1}
%       - tf: actual time t_k
%       - measurements: vector of measurements at time k (position or
%       position and range)
%       - data: struct containing data of the problem
%       - settings: struct containing settings of the problem
%       - constants: struct containing constants of the problem
%
%   Output:
%       - mean: mean state at time step k [n, 1]
%       - cov: covariance at time step k  [n, n]
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% computeRange - function to compute range given a state and epoch
%
%   Inputs:
%       - xx: actual state 
%       - et: actual epoch time
%       - lander: struct containing data of the lander
%
%   Output:
%       - range: relative range between orbiter and lander
% -------------------------------------------------------------------------
...
% ----------------------------------------------------------------------- %
% Function to plot visible elevation of lunar orbiter over lunar lander
% ----------------------------------------------------------------------- %
